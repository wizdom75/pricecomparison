...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
  ...
  <div class="mr-2">
    ...
    <a href="{{ url('/admin/products/delete-without-prices') }}" class="btn btn-danger">Delete products without a
      price</a>
  ...
  <table class="table table-striped table-sm">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <a class="btn btn-sm btn-outline-warning" href="/admin/products/{{ $product->id }}/edit"><span
              data-feather="edit"></span></a>
          <a class="btn btn-sm btn-outline-info"
            href="/admin/image/{{ App\ProductImageLink::where('product_id',$product->id)->value('id') }}/download"><span
              data-feather="download"></a></span>
          <a class="btn btn-sm btn-outline-success" href="/admin/set_prices/{{$product->id}}"><span
